...
| You create an API key at your dealer-entity. You pull 51GB of data each month.                                                                                   | $50 x 1 entity with at least one API key * 2 blocks of 50GB of data transfer = **$50/mo** |
